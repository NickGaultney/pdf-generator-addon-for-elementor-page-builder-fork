...
<table class="wp-list-table form-table">
	<tbody>
		<tr>
			<th><?php esc_html_e('PDF Page Size', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				<select name="rtw_pgaepb_css_setting_opt[pdf_page_size]">
				<option>Select</option>
				<?php foreach ($pdf_page_size as $key => $value) { ?>
					<option value="<?php echo esc_attr($value); ?>" <?php echo esc_attr( isset($rtw_wprh_get_setting['pdf_page_size']) && $rtw_wprh_get_setting['pdf_page_size'] == $value ? 'selected="selected"' : ''); ?>><?php echo esc_attr($key); ?></option>
				<?php } ?>
				</select>
				<div class="descr"><?php esc_html_e('Choose the size of PDF page', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('PDF Page Orientation', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				<p>
					<input name="rtw_pgaepb_css_setting_opt[page_orien]" value="P" <?php echo esc_attr( isset($rtw_wprh_get_setting['page_orien']) && $rtw_wprh_get_setting['page_orien'] == 'P'  ? 'checked="checked"' : ''); ?> type="radio"/>
					<?php esc_html_e('Portrait', 'pdf-generator-addon-for-elementor-page-builder');?>
				</p>
				<p>
					<input name="rtw_pgaepb_css_setting_opt[page_orien]" value="L" <?php echo esc_attr( isset($rtw_wprh_get_setting['page_orien']) && $rtw_wprh_get_setting['page_orien'] == 'L'  ? 'checked="checked"' : ''); ?> type="radio"/>
					<?php esc_html_e('Landscape', 'pdf-generator-addon-for-elementor-page-builder');?>
				</p>
				<div class="descr"><?php esc_html_e('Choose your required page Orientation of PDF.', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('Body Top Margin', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2"><input type="number" min="0" name="rtw_pgaepb_css_setting_opt[body_top_margin]" value="<?php echo esc_attr(isset($rtw_wprh_get_setting['body_top_margin']) ? $rtw_wprh_get_setting['body_top_margin'] : '37'); ?>" />
				<div class="descr"><?php esc_html_e('Enter your required top margin for main PDF body (By default 37). Minimum 37 required otherwise will not work', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('Body Left Margin', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2"><input type="number" min="0" name="rtw_pgaepb_css_setting_opt[body_left_margin]" value="<?php echo esc_attr( isset($rtw_wprh_get_setting['body_left_margin']) ? $rtw_wprh_get_setting['body_left_margin'] : '15'); ?>" />
				<div class="descr"><?php esc_html_e('Enter your required left margin for main PDF body (By default 15)', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('Body Right Margin', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2"><input type="number" min="0" name="rtw_pgaepb_css_setting_opt[body_right_margin]" value="<?php echo esc_attr( isset($rtw_wprh_get_setting['body_right_margin']) ? $rtw_wprh_get_setting['body_right_margin'] : '15'); ?>" />
				<div class="descr"><?php esc_html_e('Enter your required right margin for main PDF body (By default 15)', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('Body Font Family', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				<select name="rtw_pgaepb_css_setting_opt[body_font_family]">
				<?php 
				foreach ( $rtw_fonts as $key => $value )  { ?>
					<option value="<?php echo esc_attr($value); ?>" <?php echo esc_attr( isset($rtw_wprh_get_setting['body_font_family']) && $rtw_wprh_get_setting['body_font_family'] == $value ? 'selected="selected"' : ''); ?>><?php echo esc_attr($key); ?></option>
				<?php } ?>
				</select>
				<div class="descr"><?php esc_html_e('Choose the font family for the generated PDF', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('Body Font Size', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2"><input type="number" min="0" name="rtw_pgaepb_css_setting_opt[body_font_size]"
				value="<?php echo esc_attr( isset($rtw_wprh_get_setting['body_font_size']) ? $rtw_wprh_get_setting['body_font_size'] : '15'); ?>" />
			<div class="descr"><?php esc_html_e('Enter your required font size for Body of the PDF (By default 15)', 'pdf-generator-addon-for-elementor-page-builder');?></div>

			</td>
		</tr>
		<tr>
			<th class="tr1"><?php esc_html_e('PDF Custom CSS', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				<textarea name="rtw_pgaepb_css_setting_opt[rtw_pdf_css]" rows="8" cols="50"><?php echo esc_attr( isset($rtw_wprh_get_setting['rtw_pdf_css']) ? $rtw_wprh_get_setting['rtw_pdf_css'] : ''); ?></textarea>
			<div class="descr"><?php esc_html_e('Enter your required custom CSS for PDF', 'pdf-generator-addon-for-elementor-page-builder');?></div>
